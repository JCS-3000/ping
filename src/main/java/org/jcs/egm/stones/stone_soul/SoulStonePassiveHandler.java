...
public class SoulStonePassiveHandler {
    ...
    public static void onPlayerDeath(LivingDeathEvent event) {
        ...
        // Does player have Soul Stone, Soul Stone Holder (red skull) with Soul Stone, or Gauntlet+Stone?
        boolean found = false;
        for (ItemStack stack : player.getInventory().items) {
            ...
            if (stack.is(ModItems.SOUL_STONE_HOLDER.get())) {
                ...
                if (inside != null && inside.is(ModItems.SOUL_STONE.get())) {
                    found = true;
                    break;
                }
            }

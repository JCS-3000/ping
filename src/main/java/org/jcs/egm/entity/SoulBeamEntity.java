...
public class SoulBeamEntity extends Entity {
    ...
    public static final EntityDataAccessor<Float> START_X = SynchedEntityData.defineId(SoulBeamEntity.class, EntityDataSerializers.FLOAT);
    public static final EntityDataAccessor<Float> START_Y = SynchedEntityData.defineId(SoulBeamEntity.class, EntityDataSerializers.FLOAT);
    public static final EntityDataAccessor<Float> START_Z = SynchedEntityData.defineId(SoulBeamEntity.class, EntityDataSerializers.FLOAT);
    public static final EntityDataAccessor<Float> END_X = SynchedEntityData.defineId(SoulBeamEntity.class, EntityDataSerializers.FLOAT);
    public static final EntityDataAccessor<Float> END_Y = SynchedEntityData.defineId(SoulBeamEntity.class, EntityDataSerializers.FLOAT);
    public static final EntityDataAccessor<Float> END_Z = SynchedEntityData.defineId(SoulBeamEntity.class, EntityDataSerializers.FLOAT);

    // Track last tick endpoints were set (for instant despawn)
    private int lastUpdatedTick = 0;

    public SoulBeamEntity(EntityType<?> type, Level world) {
        super(type, world);
        this.noPhysics = true;
    }

...
public class PowerStoneEffectTwo extends TextureSheetParticle {
    private final SpriteSet spriteSet;

    protected PowerStoneEffectTwo(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z,
            ...
            return new PowerStoneEffectTwo(level, x, y, z, xSpeed, ySpeed, zSpeed, spriteSet);
        }
    }
}

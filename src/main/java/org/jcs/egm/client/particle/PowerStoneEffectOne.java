...
public class PowerStoneEffectOne extends TextureSheetParticle {
    private final SpriteSet spriteSet;

    protected PowerStoneEffectOne(ClientLevel level, double x, double y, double z,
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType type, ClientLevel level, double x, double y, double z,
            ...
            return new PowerStoneEffectOne(level, x, y, z, xSpeed, ySpeed, zSpeed, spriteSet);
        }
    }
}
